...
export const ClassConfig: ClassConfigData =  {
  CLASSES: [
      "鸣金虹", "鸣金影", "破竹尘", "破竹风", "破竹鸢", 
      "裂石威", "裂石钧（双切）", "裂石钧（纯唐）", "牵丝霖", "牵丝玉"
  ],

  // 各流派允许的武器类型 (ID)
  WEAPON_RULES: {
      "鸣金虹": ['1', '2'], "鸣金影": ['1', '2'],
      "破竹尘": ['3', '5'], "破竹风": ['6', '5'], "破竹鸢": ['9', '5'],
      "裂石威": ['7', '2'], "裂石钧（双切）": ['8', '7'], "裂石钧（纯唐）": ['8', '7'],
      "牵丝霖": ['3', '4'], "牵丝玉": ['3', '4']
  },
  ...
  DEFAULT_SETS: {
      "鸣金虹": "玉斗",
      "鸣金影": "飞隼", "破竹风": "飞隼", "牵丝玉": "飞隼",
      "牵丝霖": "时雨", "裂石威": "时雨", "裂石钧（双切）": "时雨",
      "裂石钧（纯唐）": "断岳",
      "破竹尘": "连星",
      "破竹鸢": "撼天"
  },
  ...
  // 心法推荐规则
  XINFA_RULES: {
      "鸣金影": { default: ["易水歌", "剑气纵横", "逐狼心经", "凝神章"], extra: ["移经易武", "断石之构"] },
      "鸣金虹": { default: ["易水歌", "无名心法", "威猛歌", "千山法"], extra: ["断石之构"] },
      "裂石威": { default: ["易水歌", "山河绝韵", "穿喉决", "移经易武"], extra: ["断石之构", "抗造大法", "威猛歌"] },
      "裂石钧（纯唐）": { default: ["易水歌", "霜天白夜", "穿喉决", "征人归"], extra: ["断石之构"] },
      "裂石钧（双切）": { default: ["易水歌", "霜天白夜", "孤忠不辞", "穿喉决"], extra: ["断石之构"] },
      "破竹风": { default: [ "忘川绝响", "心弥泥鱼", "极乐泣血","易水歌"], extra: ["断石之构"] },
      "破竹尘": { default: ["易水歌", "千营一呼", "绳舟行木", "所恨年年" ], extra: ["大唐歌","断石之构", "灯儿亮"] },
      "破竹鸢": { default: ["易水歌", "扶摇直上", "擒天势", "断石之构"], extra: ["三穷致知"] },
      "牵丝霖": { default: ["易水歌", "君臣药", "怒斩马", "征人归"], extra: ["断石之构", "杏花不见", "千丝蛊"] },
